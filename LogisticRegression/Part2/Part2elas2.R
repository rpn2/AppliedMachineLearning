...
for (trial in 1:kfolds){
  ...
  cvfit = cv.glmnet(as.matrix(trdata[,1:23]), trdata[,24],alpha=0.5, nfolds = 10,type.measure="class",family="binomial")
  plot(cvfit, main="Elastic regression alpha 0.5",cex.main=1.0)
